...
class ComisionesRoutes {
    ...
    config() {
        ...
        this.router.get('/listComisionesByProfesoByPeriodo/:idProfesor/:fechaIni/:fechaFin', ComisionesController_1.comisionesController.listComisionesByProfesoByPeriodo);
    }
}
