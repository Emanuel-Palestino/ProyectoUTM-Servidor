...
class ProfesoresController {
    ...
    getProfesoresByArticulo(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const respuesta = yield database_1.default.query('SELECT P.nombreProfesor, P.idProfesor FROM profesores as P INNER JOIN profesorYArticulo AP ON AP.idProfesor=P.idProfesor WHERE AP.idArticulo=?', idArticulo);
            res.json(respuesta);
        });
    }
