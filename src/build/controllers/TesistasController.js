    ...
    updatePrioridadesTestistas(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < req.body.length; i++) {
                ...
                //Actualizamos 
                respuesta = yield database_1.default.query('UPDATE profesorYTesis SET ? WHERE idTesis = ? AND idProfesor = ? AND esInterno = 1', [elementoBody, idTesis, elementoBody.idProfesor]);
            }
            res.json(respuesta);
        });
    }
